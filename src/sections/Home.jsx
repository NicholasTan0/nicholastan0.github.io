const Home = () => {
    return (
        <section id="home" className="relative z-99 flex flex-wrap mx-[8vw] min-h-[90vh]">
            ...
            <div className="appearFirst flex flex-2/5 flex-col justify-center mb-8">
            ...
            <a href="#about" className="svg-down absolute bottom-[-3.5vh] left-[48.5%] z-10 bg-[rgba(255,255,255,0.4)] p-2 rounded-full">
