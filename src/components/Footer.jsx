const Footer = () => {
    return (
        <footer className="flex flex-col justify-center items-center py-4 bg-[var(--secondary)] gap-3">
            ...
            <span className="text-sm font-extralight text-center">Nicholas Tan @ 2025</span>
        </footer>
    )
}
